...
Source0  : https://www.kernel.org/pub/linux/docs/man-pages/man-pages-5.06.tar.xz
...
%prep
%setup -q -n man-pages-5.06
cd %{_builddir}/man-pages-5.06
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586802412
