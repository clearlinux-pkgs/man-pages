...
Source0  : https://www.kernel.org/pub/linux/docs/man-pages/man-pages-5.07.tar.xz
...
%prep
%setup -q -n man-pages-5.07
cd %{_builddir}/man-pages-5.07
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591737093
...
/usr/share/man/man5/numa_maps.5
