...
Version  : 6.7
Release  : 68
URL      : https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.7.tar.xz
Source0  : https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.7.tar.xz
...
%prep
%setup -q -n man-pages-6.7
cd %{_builddir}/man-pages-6.7
pushd ..
cp -a man-pages-6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710880387
