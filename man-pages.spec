...
Source0  : https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.06.tar.xz
...
%prep
%setup -q -n man-pages-6.06
cd %{_builddir}/man-pages-6.06
pushd ..
cp -a man-pages-6.06 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707755220
