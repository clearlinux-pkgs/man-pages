...
Source0  : https://www.kernel.org/pub/linux/docs/man-pages/man-pages-5.08.tar.xz
...
%prep
%setup -q -n man-pages-5.08
cd %{_builddir}/man-pages-5.08
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597332809
